            ...
            <article className="education-entry-box">
              ...
              <div className="education-icon color-none">
                ...
                <div className="project-label">
                  ...
                  <p className="project-legend">Experience using MySQL and MySQLWorkbench for the creation and management of a database
                    to take inventory control at the "Master Wings" restaurant using a functional application written in Java.</p>
                </div>
              </div>
            </article>
            <article className="education-entry-box">
              <div className="education-entry-inner">
                <div className="project-label">
                  ...
                  <p className="project-legend">Experience handling the C programming language and libraries such as Diffie-Helman
            ...
            <article className="education-entry-box">
              <div className="education-entry-inner">
                <div className="project-label">
                  ...
                  <p className="project-legend">Experience using Hyper-Spectral equipment and related technologies for taking
                  Hyper-Spectral photos of fruits such as cocoa to analyze their index / degree of fermentation.</p>
                </div>
              </div>
            </article>
            <article className="education-entry-box">
              <div className="education-entry-inner">
                <div className="project-last-label">
